...
int BlueMen::attacking() {
  ...
  std::cout <<"\nThe Blue Men attack with a roll of "<< roll << std::endl;
...
int BlueMen::defending() {
  ...
  if(strength > 8) {
    ...
    std::cout <<"\nThe Blue Men defend with a roll of "<< roll << std::endl;
...
void BlueMen::setStrength(int s) {
  ...
  if(strength <= 0 && strength > -100) {
    strength = 0;
    std::cout << "\nThe Blue Men scream out in tiny squeals of pain\n";
    std::cout << "They fall to the floor in a tiny blue pile...\n";
    std::cout << "never to battle again...\n";
  }
  else if(strength < -100) {
    strength = 0;
    std::cout << "The Blue Men shriek as they make eye contact with\n";
