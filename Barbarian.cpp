...
int Barbarian::attacking() {
  ...
  std::cout <<"\nThe Barbarian attacks with a roll of "<< roll << std::endl;
...
int Barbarian::defending() {
  ...
  std::cout <<"\nThe Barbarian defends with a roll of "<< roll << std::endl;
...
void Barbarian::setStrength(int s) {
  ...
  if(strength <= 0 && strength > -100) {
    strength = 0;
    std::cout << "\nThe barbarian falls and clutches his fatal wound...\n";
    ...
    strength = 0;
    std::cout << "\nThe Barbarian feels his body hardening to stone...\n";
